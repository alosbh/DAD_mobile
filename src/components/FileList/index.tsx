...
export function FileList(){
  ...
  useEffect(()=>{
    async function fetchMessages(){
      ...
      const topicsResponse = [{folderId:"1",folderName:"Avisos",files:[{fileId:"1",filename:"Inicio das Aulas",icon:"pdffile1",url:"http://www.africau.edu/images/default/sample.pdf"},{fileId:"2",filename:"Cronograma",icon:"pptfile1",url:"https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/dummy.pdf"}]},
